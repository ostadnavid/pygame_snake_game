...
w, h = 780, 510
fps = 30
step = 15 # this makes the objects bigger
...
base_image = np.zeros((len(y_range), len(x_range)), dtype='float32')
...
while True:
  # vision, directions, length = get_state()
  # print(vision, directions)
